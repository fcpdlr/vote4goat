...
<a href="/rank4" className="text-xs text-white/40 hover:text-white/70 transition">Back to R4NK</a>
</header>
...
<a href="/rank4" className="text-white/40 hover:text-white/70 transition">Back to R4NK</a>
{user ? (
            ...
            <div className="flex flex-col gap-2">
              {availableOptions.map((opt, i) => (
                <button
                  ...
                  className="w-full text-left px-4 py-3 rounded-2xl border border-white/10 bg-white/4 text-sm text-white/75 hover:bg-white/8 hover:text-white hover:border-goat/30 active:scale-98 transition font-medium"
                >
                  {opt}
                </button>
              ))}
