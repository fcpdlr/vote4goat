...
size={26}
strokeWidth={1.5}
className={active ? ‘text-goat’ : ‘text-white/40’}
/>
),
},
{
...
accent: [1, 2],
icon: (active) => (
<svg width="26" height="26" viewBox="0 0 88 88" fill="none">
        ...
        {modes.map((mode, idx) => {
          ...
          return (
            <button
              ...
              className={`flex-1 flex flex-col items-center gap-2 py-4 transition relative
            ...
            >
              {mode.icon(active)}
              <div className="text-xl sm:text-2xl font-black tracking-wider leading-none" style={{ fontFamily: 'system-ui, sans-serif' }}>
