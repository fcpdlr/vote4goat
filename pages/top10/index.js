...
const getCategoryTheme = (slug) => {
  ...
  if (s.includes('real-madrid')) {
    return {
      cardClass: 'bg-gradient-to-br from-white via-gray-100 to-gray-300 border-gray-300 hover:border-goat',
  ...
  if (s.includes('fc-barcelona') || s.includes('barcelona-all-time')) {
    return {
      cardClass: 'bg-gradient-to-br from-[#004d98] via-[#004d98] to-[#a50044] border-[#a50044]/80 hover:border-white',
  ...
  if (s.includes('bayern')) {
    return {
      cardClass: 'bg-gradient-to-br from-[#dc052d] via-[#b80024] to-[#750014] border-[#ffb3c2]/40 hover:border-white',
  ...
  if (s.includes('manchester-united')) {
    return {
      cardClass: 'bg-gradient-to-br from-[#da291c] via-[#a00012] to-black border-[#fbe122]/40 hover:border-white',
  ...
  if (s.includes('liverpool')) {
    return {
      cardClass: 'bg-gradient-to-br from-[#c8102e] via-[#8b0018] to-[#111827] border-[#f6e3e7]/40 hover:border-white',
  ...
  if (s.includes('ac-milan') || s.includes('milan-all-time')) {
    return {
      cardClass: 'bg-gradient-to-br from-black via-[#111827] to-[#a0001e] border-[#ffccd5]/40 hover:border-white',
  ...
  if (s.includes('boca')) {
    return {
      cardClass: 'bg-gradient-to-br from-[#0033a0] via-[#0033a0] to-[#ffcc00] border-[#ffcc00]/60 hover:border-white',
  ...
  if (s.includes('river')) {
    return {
      cardClass: 'bg-gradient-to-br from-white via-[#f3f4f6] to-[#e11d48] border-[#fecaca]/60 hover:border-white',
  ...
  if (s.startsWith('brazil-')) {
    return {
      cardClass: 'bg-gradient-to-br from-[#ffdf00] via-[#ffdf00] to-[#009c3b] border-[#fde68a]/70 hover:border-white',
  ...
  if (s.startsWith('argentina-')) {
    return {
      cardClass: 'bg-gradient-to-br from-[#75aadb] via-[#75aadb] to-white border-[#bfdbfe]/70 hover:border-white',
  ...
  if (s.startsWith('france-')) {
    return {
      cardClass: 'bg-gradient-to-br from-[#0055a4] via-[#003366] to-[#e51b23] border-[#bfdbfe]/70 hover:border-white',
  ...
  if (s.startsWith('germany-')) {
    return {
      cardClass: 'bg-gradient-to-br from-black via-[#111827] to-white border-[#e5e7eb]/60 hover:border-white',
  ...
  if (s.startsWith('spain-')) {
    return {
      cardClass: 'bg-gradient-to-br from-[#aa151b] via-[#aa151b] to-[#f1bf00] border-[#fecaca]/70 hover:border-white',
      titleClass: 'text-white group-hover:text-yellow-200',
      badgeClass: 'bg-black/50 border-white/30 text-gray-100',
    }
  }
  ...
  if (s.startsWith('italy-')) {
    return {
      cardClass: 'bg-gradient-to-br from-[#0072ce] via-[#0072ce] to-white border-[#bfdbfe]/70 hover:border-white',
  ...
  if (s.startsWith('england-')) {
    return {
      cardClass: 'bg-gradient-to-br from-white via-[#f3f4f6] to-[#c8102e] border-[#fecaca]/70 hover:border-white',
    ...
    return (
      <section className="mb-12">
        <div className="mb-4 text-center space-y-1">
          <h2 className="text-lg sm:text-xl font-bold text-goat">{title}</h2>
            ...
            return (
              ...
              >
                <div className="flex items-center justify-center gap-2 mb-2 px-2">
                  <h3
                    className={'text-sm sm:text-base font-semibold line-clamp-2 ' + theme.titleClass}
                    style={{ fontVariant: 'small-caps' }}
                  >
                    {cat.title}
                  </h3>
                </div>
                <span className={'mt-1 inline-flex items-center justify-center text-[10px] px-2 py-[3px] rounded-full ' + theme.badgeClass}>
      ...
      <main className="min-h-screen bg-background px-4 pt-2 text-white font-sans flex flex-col">
        <header className="flex items-center justify-between px-3 py-2">
          ...
          <nav className="flex items-center gap-3 text-xs sm:text-sm">
            <a href="/top10" className="hover:underline text-goat font-semibold">Top 10s</a>
        ...
        {showHelp && (
          <div ref={helpRef} className="max-w-xl mx-auto text-sm bg-white/5 text-white p-4 rounded-xl mt-2 border border-white/10">
            ...
            <p className="mb-2">Vote4GOAT started with 1vs1 duels and now adds Top 10 lists for clubs and national teams. Build your own rankings and see how they compare with the community.</p>
        ...
        <div className="flex-1 mt-6 mb-10">
          <div className="max-w-5xl mx-auto">
            <div className="text-center mb-8 space-y-2">
              <p className="text-[11px] tracking-[0.2em] uppercase text-gray-400">Top 10 mode</p>
              <h1 className="text-2xl sm:text-3xl font-extrabold text-goat">Build your all-time rankings</h1>
            ...
            {isLoading ? (
              ...
              <p className="text-sm text-gray-300 text-center">No Top 10 categories available yet.</p>
            ) : (
              <>
