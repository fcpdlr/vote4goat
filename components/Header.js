...
const CrownLogo = () => (
<svg width="22" height="20" viewBox="0 0 64 56" fill="none" xmlns="http://www.w3.org/2000/svg">
  ...
  <div className="flex items-center justify-between px-4 py-2.5">
    ...
    <a href="/" className="flex items-center gap-2 hover:opacity-85 transition">
      ...
      <span className="text-base font-extrabold tracking-wide leading-none">
        <span className="text-white/45 font-semibold">VOTE</span>
    ...
    {MODES.map((mode) => {
      ...
      return (
        <a
          ...
          href={mode.href}
          className={`
            relative flex-1 flex flex-col items-center justify-center py-2 gap-0.5 transition
            ${isActive
              ? "text-white"
        ...
        >
          {/* Mode label */}
          <span className={`text-sm font-black tracking-wider leading-none ${isActive ? "text-white" : ""}`}
